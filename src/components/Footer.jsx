...
const Footer = () => {
    ...
    return (
        <footer className="bg-gradient-to-r from-amber-900 to-amber-950 text-white mt-12">
            <div className="container mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                    {/* About Section */}
                    <div>
                        <div className="flex items-center gap-3 mb-4">
                            <img src="/logo.png" alt="COCO Hotel Logo" className="h-14 w-auto" />
                            <h3 className="text-xl font-bold font-serif">COCO Hotel</h3>
                        </div>
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-start gap-3 text-sm">
                                ...
                                <span className="text-white/70">
                                    123 Ocean Drive, Beach Paradise, Mumbai 400001
                                </span>
                            </li>
                            ...
                            <li className="flex items-center gap-3 text-sm">
                                ...
                                <a href="mailto:info@cocohotel.com" className="text-white/70 hover:text-accent transition">
                                    info@cocohotel.com
                                </a>
                            </li>
                        </ul>
                ...
                <div className="border-t border-white/10 pt-6 mt-6">
                    <div className="flex justify-center items-center">
                        <p className="text-white/60 text-sm">
                            © {currentYear} COCO Hotel. All rights reserved.
                        </p>
